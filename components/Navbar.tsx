...
const Navbar = () => {
  ...
  return (
    <div className={`${!openSideMenu&& !isMobile && changeNavBar? 'lg:w-[80vw] md:w-[90vw] top-4 border-[1px] border-2/10 shadow-lg rounded-4xl bg-1 left-1/2 -translate-x-1/2' : 'w-full top-0 left-0 translate-x-0'} fixed z-40 h-[85px] flex px-5 items-center justify-center transition-all duration-1000 ease-in-out ${openSideMenu? 'backdrop-blur-none' : 'backdrop-blur-2xl'}`}>
